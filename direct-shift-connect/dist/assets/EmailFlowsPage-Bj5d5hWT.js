import{l as ye,i as ge,r as m,j as e,B as r,M as N,n as U,o as Q,p as J,q as G,H as we,I as x,h as oe,S as ie,U as re,J as je,aa as C,b as c,a as f}from"./index-BWl1aTm6.js";import{L as u}from"./label-R9xz-fNQ.js";import{T as be}from"./textarea-C74cEPuH.js";import{C as w,d as j}from"./card-DJ8fm8N1.js";import{B as F}from"./badge-CVh0Bcd7.js";import{S as ve,a as Ne,b as Se,c as De,d as I,C as Z,e as K}from"./select-C2DcoNzC.js";import{S as Ae}from"./EmailPage-DMz6gvjC.js";import{P as V}from"./plus-CzU8dQOz.js";import{Z as ke}from"./zap-GgKu7PWM.js";import{C as S}from"./clock-DYKXUbVs.js";import{P as X,a as ee}from"./play-CBHVVZ-4.js";import{C as Ce}from"./copy-sU_xd4OA.js";import{T as te}from"./trash-2-Dxh_TUkr.js";import"./index-DnjwuIBd.js";import"./PageHeader-BeL37qYb.js";import"./tabs-BC52WKYV.js";function se(l){return{id:l.id,name:l.name,description:l.description||"",audience:l.audience,status:l.status,steps:l.steps||[],createdAt:l.created_at,updatedAt:l.updated_at}}function Fe(l,b,B="{{name}}"){return`
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
Cheers,
Anurag
Co-Founder, StatDoctor`}],createdAt:new Date().toISOString(),updatedAt:new Date().toISOString()}];function D(){return Math.random().toString(36).slice(2,10)}const E={hospitals:{icon:oe,label:"Hospitals",color:"bg-purple-100 text-purple-800"},doctors:{icon:ie,label:"Doctors",color:"bg-blue-100 text-blue-800"},investors:{icon:re,label:"Investors",color:"bg-green-100 text-green-800"}},H={draft:{label:"Draft",color:"bg-slate-100 text-slate-700"},active:{label:"Active",color:"bg-green-100 text-green-800"},paused:{label:"Paused",color:"bg-amber-100 text-amber-800"}};function Ue(){const l=ye(),{data:b=[],isLoading:B}=ge({queryKey:["email-flows"],queryFn:async()=>{const{data:t,error:a}=await f.from("email_flows").select("*").order("created_at",{ascending:!1});return a?ae:(t||[]).length>0?t.map(se):ae}}),[s,n]=m.useState(null),[ne,q]=m.useState(!1),[v,le]=m.useState(null),[ce,y]=m.useState(!1),[de,P]=m.useState(null),g=()=>l.invalidateQueries({queryKey:["email-flows"]}),[A,W]=m.useState(""),[O,T]=m.useState(""),[z,me]=m.useState("hospitals"),ue=async()=>{if(!A.trim()){c.error("Flow name is required");return}const t=[{id:D(),type:"email",subject:"",body:`Hi {{name}},
